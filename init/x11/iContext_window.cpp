...
int iContext::createFrameBuffer() {
   ...
   for ( i = 0; i < vNumOfFBConfigs_I; i++ ) {
      ...
      if ( temp ) {
         ...
         // glXGetFBConfigAttrib( vDisplay_X11, vFBConfig_GLX[i], GLX_DEPTH_SIZE, &depth ); This
   ...
   glXGetFBConfigAttrib(
         vDisplay_X11, vFBConfig_GLX[vBestFBConfig_I], GLX_X_RENDERABLE, &lFBAttribs_A_I[0] );
   glXGetFBConfigAttrib(
         vDisplay_X11, vFBConfig_GLX[vBestFBConfig_I], GLX_DOUBLEBUFFER, &lFBAttribs_A_I[1] );
   glXGetFBConfigAttrib(
         vDisplay_X11, vFBConfig_GLX[vBestFBConfig_I], GLX_RENDER_TYPE, &lFBAttribs_A_I[2] );
   glXGetFBConfigAttrib(
         vDisplay_X11, vFBConfig_GLX[vBestFBConfig_I], GLX_X_VISUAL_TYPE, &lFBAttribs_A_I[3] );
   glXGetFBConfigAttrib(
         vDisplay_X11, vFBConfig_GLX[vBestFBConfig_I], GLX_CONFIG_CAVEAT, &lFBAttribs_A_I[4] );
   glXGetFBConfigAttrib(
         vDisplay_X11, vFBConfig_GLX[vBestFBConfig_I], GLX_DRAWABLE_TYPE, &lFBAttribs_A_I[5] );
   glXGetFBConfigAttrib(
         vDisplay_X11, vFBConfig_GLX[vBestFBConfig_I], GLX_STEREO, &lFBAttribs_A_I[6] );
   glXGetFBConfigAttrib(
...
// clang-format on
   ...
   vVisualInfo_X11 = glXGetVisualFromFBConfig(
...
int iContext::createOGLContext() {
   ...
   if ( !isExtensionSupported( "GLX_ARB_create_context" ) || !glXCreateContextAttribsARB ) {
      ...
      vOpenGLContext_GLX = glXCreateNewContext(
            vDisplay_X11, vFBConfig_GLX[vBestFBConfig_I], GLX_RGBA_TYPE, nullptr, true );
   } else {
      ...
      if ( ( GlobConf.versions.glMinorVersion < 0 || GlobConf.versions.glMajorVersion < 0 ) &&
         ...
         iLOG( "Try to use OpenGL version ",
      ...
      for ( unsigned short int i = 0; version_list[i][0] != 0 || version_list[i][1] != 0; i++ ) {
         vOpenGLContext_GLX = glXCreateContextAttribsARB(
               vDisplay_X11, vFBConfig_GLX[vBestFBConfig_I], nullptr, true, lAttributes_A_I );
