      ...
      while ( XPending( getDisplay() ) > 0 && getHaveContext() ) {
         ...
         switch ( lEvent_X11.type ) {
            ...
            case MotionNotify: {
                  ...
                  tempInfo.type          = E_EVENT_MOUSE;
                  GlobConf.win.mousePosX  = tempInfo.eMouse.posX   = lEvent_X11.xmotion.x;
                  GlobConf.win.mousePosY  = tempInfo.eMouse.posY   = lEvent_X11.xmotion.y;
