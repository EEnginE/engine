...
int iWindow::createWindow() {
  ...
  lValues[1] = XCB_EVENT_MASK_KEY_PRESS | XCB_EVENT_MASK_KEY_RELEASE | XCB_EVENT_MASK_BUTTON_PRESS |
               XCB_EVENT_MASK_BUTTON_RELEASE | XCB_EVENT_MASK_ENTER_WINDOW | XCB_EVENT_MASK_LEAVE_WINDOW |
               XCB_EVENT_MASK_POINTER_MOTION | XCB_EVENT_MASK_BUTTON_1_MOTION | XCB_EVENT_MASK_BUTTON_2_MOTION |
               XCB_EVENT_MASK_BUTTON_3_MOTION | XCB_EVENT_MASK_BUTTON_4_MOTION | XCB_EVENT_MASK_BUTTON_5_MOTION |
               XCB_EVENT_MASK_BUTTON_MOTION | XCB_EVENT_MASK_EXPOSURE | XCB_EVENT_MASK_VISIBILITY_CHANGE |
               XCB_EVENT_MASK_STRUCTURE_NOTIFY | XCB_EVENT_MASK_FOCUS_CHANGE | XCB_EVENT_MASK_PROPERTY_CHANGE;
  ...
  std::string  lEngineGit_str =
      E_GIT_LAST_TAG_DIFF == 0 ? " [RELEASE] " : (" +" + std::to_string(E_GIT_LAST_TAG_DIFF) + " ");
 ...
 * \param _action Can be ACTION::C_REMOVE, ACTION::C_ADD or ACTION::C_TOGGLE
 */
void iWindow::maximize(e_engine::ACTION _action) { setAttribute(_action, MAXIMIZED_HORZ, MAXIMIZED_VERT); }
...
void iWindow::setAttribute(ACTION _action, WINDOW_ATTRIBUTE _type1, WINDOW_ATTRIBUTE _type2) {
  ...
  if (_type1 == _type2) {
    eLOG(
        "Changing the same attribute at the same time makes completely no sense. ==> Do "
        "nothing");
    return;
  }
  ...
  sendX11Event(vNetWmState_ATOM, _action, static_cast<uint32_t>(lAtom1_XCB), static_cast<uint32_t>(lAtom2_XCB), 1);
...
bool iWindow::grabMouse() {
  ...
  auto lCookie = xcb_grab_pointer(vConnection_XCB,     // Our connection to the X server
                                  1,                   // Still get events
