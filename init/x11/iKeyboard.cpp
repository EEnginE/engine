...
static struct codepair {
   ...
   unsigned short ucs;
        ...
        {0x07b6, 0x0390}, /*    Greek_iotaaccentdieresis ΐ GREEK SMALL LETTER IOTA WITH DIALYTIKA
                             AND TONOS */
        ...
        {0x07ba,
         0x03b0}, /* Greek_upsilonaccentdieresis ΰ GREEK SMALL LETTER UPSILON WITH DIALYTIKA AND
                     TONOS */
...
wchar_t iKeyboard::processX11KeyInput( XKeyPressedEvent _kEv,
   ...
   if ( level1 == 1 ) {
      ...
      switch ( key ) {
         case XK_KP_0:
            ...
            return E_KEY_KP_0;
         case XK_KP_1:
            setKeyState( E_KEY_KP_1, _key_state );
            return E_KEY_KP_1;
         case XK_KP_2:
            setKeyState( E_KEY_KP_2, _key_state );
            return E_KEY_KP_2;
         case XK_KP_3:
            setKeyState( E_KEY_KP_3, _key_state );
            return E_KEY_KP_3;
         case XK_KP_4:
            setKeyState( E_KEY_KP_4, _key_state );
            return E_KEY_KP_4;
         case XK_KP_5:
            setKeyState( E_KEY_KP_5, _key_state );
            return E_KEY_KP_5;
         case XK_KP_6:
            setKeyState( E_KEY_KP_6, _key_state );
            return E_KEY_KP_6;
         case XK_KP_7:
            setKeyState( E_KEY_KP_7, _key_state );
            return E_KEY_KP_7;
         case XK_KP_8:
            setKeyState( E_KEY_KP_8, _key_state );
            return E_KEY_KP_8;
         case XK_KP_9:
            setKeyState( E_KEY_KP_9, _key_state );
            return E_KEY_KP_9;
      }
   }
   ...
   switch ( key ) {
      case XK_BackSpace:
         setKeyState( E_KEY_BACKSPACE, _key_state );
         return E_KEY_BACKSPACE;
      case XK_Tab:
         setKeyState( E_KEY_TAB, _key_state );
         return E_KEY_TAB;
      case XK_Clear:
         setKeyState( E_KEY_CLEAR, _key_state );
         return E_KEY_CLEAR;
      case XK_Return:
         setKeyState( E_KEY_RETURN, _key_state );
         return E_KEY_RETURN;
      case XK_Pause:
         setKeyState( E_KEY_PAUSE, _key_state );
         return E_KEY_PAUSE;
      case XK_Sys_Req:
         setKeyState( E_KEY_SYS_REQ, _key_state );
         return E_KEY_SYS_REQ;
      case XK_Escape:
         setKeyState( E_KEY_ESCAPE, _key_state );
         return E_KEY_ESCAPE;
      case XK_KP_Delete:
      case XK_Delete:
         setKeyState( E_KEY_DELETE, _key_state );
         return E_KEY_DELETE;

      case XK_Scroll_Lock:
         setKeyState( E_KEY_SCROLL_LOCK, _key_state );
         return E_KEY_SCROLL_LOCK;
      case XK_Caps_Lock:
         setKeyState( E_KEY_CAPS_LOCK, _key_state );
         return E_KEY_CAPS_LOCK;

      case XK_F1:
         setKeyState( E_KEY_F1, _key_state );
         return E_KEY_F1;
      case XK_F2:
         setKeyState( E_KEY_F2, _key_state );
         return E_KEY_F2;
      case XK_F3:
         setKeyState( E_KEY_F3, _key_state );
         return E_KEY_F3;
      case XK_F4:
         setKeyState( E_KEY_F4, _key_state );
         return E_KEY_F4;
      case XK_F5:
         setKeyState( E_KEY_F5, _key_state );
         return E_KEY_F5;
      case XK_F6:
         setKeyState( E_KEY_F6, _key_state );
         return E_KEY_F6;
      case XK_F7:
         setKeyState( E_KEY_F7, _key_state );
         return E_KEY_F7;
      case XK_F8:
         setKeyState( E_KEY_F8, _key_state );
         return E_KEY_F8;
      case XK_F9:
         setKeyState( E_KEY_F9, _key_state );
         return E_KEY_F9;
      case XK_F10:
         setKeyState( E_KEY_F10, _key_state );
         return E_KEY_F10;
      case XK_F11:
         setKeyState( E_KEY_F11, _key_state );
         return E_KEY_F11;
      case XK_F12:
         setKeyState( E_KEY_F12, _key_state );
         return E_KEY_F12;
      case XK_F13:
         setKeyState( E_KEY_F13, _key_state );
         return E_KEY_F13;
      case XK_F14:
         setKeyState( E_KEY_F14, _key_state );
         return E_KEY_F14;
      case XK_F15:
         setKeyState( E_KEY_F15, _key_state );
         return E_KEY_F15;
      case XK_F16:
         setKeyState( E_KEY_F16, _key_state );
         return E_KEY_F16;
      case XK_F17:
         setKeyState( E_KEY_F17, _key_state );
         return E_KEY_F17;
      case XK_F18:
         setKeyState( E_KEY_F18, _key_state );
         return E_KEY_F18;
      case XK_F19:
         setKeyState( E_KEY_F19, _key_state );
         return E_KEY_F19;
      case XK_F20:
         setKeyState( E_KEY_F20, _key_state );
         return E_KEY_F20;
      case XK_F21:
         setKeyState( E_KEY_F21, _key_state );
         return E_KEY_F21;
      case XK_F22:
         setKeyState( E_KEY_F22, _key_state );
         return E_KEY_F22;
      case XK_F23:
         setKeyState( E_KEY_F23, _key_state );
         return E_KEY_F23;
      case XK_F24:
         setKeyState( E_KEY_F24, _key_state );
         return E_KEY_F24;
      case XK_F25:
         setKeyState( E_KEY_F25, _key_state );
         return E_KEY_F25;

      case XK_KP_Up:
      case XK_Up:
         setKeyState( E_KEY_UP, _key_state );
         return E_KEY_UP;
      case XK_KP_Down:
      case XK_Down:
         setKeyState( E_KEY_DOWN, _key_state );
         return E_KEY_DOWN;
      case XK_KP_Left:
      case XK_Left:
         setKeyState( E_KEY_LEFT, _key_state );
         return E_KEY_LEFT;
      case XK_KP_Right:
      case XK_Right:
         setKeyState( E_KEY_RIGHT, _key_state );
         return E_KEY_RIGHT;

      case XK_Shift_L:
         setKeyState( E_KEY_L_SHIFT, _key_state );
         return E_KEY_L_SHIFT;
      case XK_Shift_R:
         setKeyState( E_KEY_R_SHIFT, _key_state );
         return E_KEY_R_SHIFT;
      case XK_Control_L:
         setKeyState( E_KEY_L_CTRL, _key_state );
         return E_KEY_L_CTRL;
      case XK_Control_R:
         setKeyState( E_KEY_R_CTRL, _key_state );
         return E_KEY_R_CTRL;
      case XK_Meta_L:
      case XK_Alt_L:
         setKeyState( E_KEY_L_ALT, _key_state );
         return E_KEY_L_ALT;
      case XK_Mode_switch:
      case XK_Meta_R:
      case XK_ISO_Level3_Shift:
      case XK_Alt_R:
         setKeyState( E_KEY_R_ALT, _key_state );
         return E_KEY_R_ALT;
      case XK_Super_L:
         setKeyState( E_KEY_L_SUPER, _key_state );
         return E_KEY_L_SUPER;
      case XK_Super_R:
         setKeyState( E_KEY_R_SUPER, _key_state );
         return E_KEY_R_SUPER;

      case XK_KP_Home:
      case XK_Home:
         setKeyState( E_KEY_HOME, _key_state );
         return E_KEY_HOME;
      case XK_KP_Insert:
      case XK_Insert:
         setKeyState( E_KEY_INSERT, _key_state );
         return E_KEY_INSERT;
      case XK_KP_Page_Up:
      case XK_Page_Up:
         setKeyState( E_KEY_PAGE_UP, _key_state );
         return E_KEY_PAGE_UP;
      case XK_KP_Page_Down:
      case XK_Page_Down:
         setKeyState( E_KEY_PAGE_DOWN, _key_state );
         return E_KEY_PAGE_DOWN;
      case XK_KP_End:
      case XK_End:
         setKeyState( E_KEY_END, _key_state );
         return E_KEY_END;
      case XK_Menu:
         setKeyState( E_KEY_MENU, _key_state );
         return E_KEY_MENU;

      case XK_KP_Divide:
         setKeyState( E_KEY_KP_DIVIDE, _key_state );
         return E_KEY_KP_DIVIDE;
      case XK_KP_Multiply:
         setKeyState( E_KEY_KP_MULTIPLY, _key_state );
         return E_KEY_KP_MULTIPLY;
      case XK_KP_Subtract:
         setKeyState( E_KEY_KP_SUBTRACT, _key_state );
         return E_KEY_KP_SUBTRACT;
      case XK_KP_Add:
         setKeyState( E_KEY_KP_ADD, _key_state );
         return E_KEY_KP_ADD;
      case XK_KP_Equal:
         setKeyState( E_KEY_KP_EQUAL, _key_state );
         return E_KEY_KP_EQUAL;
      case XK_KP_Enter:
         setKeyState( E_KEY_KP_ENTER, _key_state );
         return E_KEY_KP_ENTER;
      case XK_Num_Lock:
         setKeyState( E_KEY_KP_NUM_LOCK, _key_state );
         return E_KEY_KP_NUM_LOCK;
   }
