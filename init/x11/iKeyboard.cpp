...
wchar_t iKeyboard::processX11KeyInput( XKeyPressedEvent _kEv, short unsigned int _key_state, Display *_display ) {
   KeySym key;
   ...
   switch ( state.led_mask ) {
         ///   Num-Lock      Shift
      case 0:  level1 = 0; level2 = 0; break;  // Num-Lock: off  ;  Shift: off
      case 1:  level1 = 0; level2 = 1; break;  // Num-Lock: off  ;  Shift: on
      case 2:  level1 = 1; level2 = 0; break;  // Num-Lock: on   ;  Shift: off
      case 3:  level1 = 1; level2 = 1; break;  // Num-Lock: on   ;  Shift: on
