...
// --- private ---
void iDisplays::addClone( RROutput _clone ) {
 ...
 */
double iDisplays::findNearestFreqTo( double _rate, unsigned int _width, unsigned int _height, RRMode &_mode, double &_diff ) const {
   _diff = 1000000;
   double lRate_D = -1;
   for ( iDisplays::mode const & fMode : vModes_V_mode ) {
