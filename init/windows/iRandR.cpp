...
void iRandR::reload() {
  ...
  for (DWORD lDeviceNum_win32 = 0; EnumDisplayDevicesW(NULL, lDeviceNum_win32, &lDisplayDevice_win32, 0);
       ++lDeviceNum_win32) {

    DISPLAY_DEVICEW lDisplayDeviceTemp_win32;
    lDisplayDeviceTemp_win32.cb = sizeof(DISPLAY_DEVICEW);

    for (DWORD lDisplayNum_win32 = 0;
      ...
      for (DWORD lModeNum_win32 = 0;
           EnumDisplaySettingsW(lDisplayDevice_win32.DeviceName, lModeNum_win32, &lSettings_win32);
           lModeNum_win32++)
...
void iRandR::printRandRStatus() {
  ...
  for (iDisplays const &d : vCurrentConfig_eD) {
    ...
    for (DEVMODEW const &D : d.vModes_V_win32) {
      dLOG("Resolution: ", (int32_t)D.dmPelsWidth, "x", (int32_t)D.dmPelsHeight, ":", (double)D.dmDisplayFrequency);
      dLOG("\n  - DM_POSITION           ",
...
bool iRandR::setPrimary(const iDisplays &_disp) {
  ...
  switch (
      ChangeDisplaySettingsExW(_disp.getDisplayDevice().DeviceName, &lNotReallyNeeded, NULL, CDS_SET_PRIMARY, NULL)) {
    ...
    case DISP_CHANGE_BADFLAGS: wLOG("ChangeDisplaySettingsEx returned DISP_CHANGE_BADFLAGS [setPrimary]"); return false;

    case DISP_CHANGE_BADMODE: wLOG("ChangeDisplaySettingsEx returned DISP_CHANGE_BADMODE [setPrimary]"); return false;

    case DISP_CHANGE_BADPARAM: wLOG("ChangeDisplaySettingsEx returned DISP_CHANGE_BADPARAM [setPrimary]"); return false;

    case DISP_CHANGE_FAILED: wLOG("ChangeDisplaySettingsEx returned DISP_CHANGE_FAILED [setPrimary]"); return false;
    ...
    case DISP_CHANGE_RESTART:
      wLOG(
          "ChangeDisplaySettingsEx returned DISP_CHANGE_FAILED [setPrimary] (You need to "
          "restart yout PC because you have Windows)");
      return false;

    default: eLOG("ChangeDisplaySettingsEx returned a unknown error [setPrimary]"); return false;
  }
  return false;
}
...
bool iRandR::applyNewRandRSettings() {
  ...
  for (iDisplays const &disp : vDisplaysToChange_eD) {
    ...
    switch (ChangeDisplaySettingsExW(disp.getDisplayDevice().DeviceName,
      ...
      case DISP_CHANGE_BADDUALVIEW: wLOG("ChangeDisplaySettingsEx returned DISP_CHANGE_BADDUALVIEW [set]"); break;

      case DISP_CHANGE_BADFLAGS: wLOG("ChangeDisplaySettingsEx returned DISP_CHANGE_BADFLAGS [set]"); break;

      case DISP_CHANGE_BADMODE: wLOG("ChangeDisplaySettingsEx returned DISP_CHANGE_BADMODE [set]"); break;

      case DISP_CHANGE_BADPARAM: wLOG("ChangeDisplaySettingsEx returned DISP_CHANGE_BADPARAM [set]"); break;

      case DISP_CHANGE_FAILED: wLOG("ChangeDisplaySettingsEx returned DISP_CHANGE_FAILED [set]"); break;

      case DISP_CHANGE_NOTUPDATED: wLOG("ChangeDisplaySettingsEx returned DISP_CHANGE_NOTUPDATED [set]"); break;

      case DISP_CHANGE_RESTART:
        wLOG(
            "ChangeDisplaySettingsEx returned DISP_CHANGE_FAILED [set] (You need to restart "
  ...
  switch (ChangeDisplaySettingsExW(NULL, NULL, NULL, 0, NULL)) {
    ...
    case DISP_CHANGE_BADDUALVIEW: wLOG("ChangeDisplaySettingsEx returned DISP_CHANGE_BADDUALVIEW [apply]"); break;

    case DISP_CHANGE_BADFLAGS: wLOG("ChangeDisplaySettingsEx returned DISP_CHANGE_BADFLAGS [apply]"); break;

    case DISP_CHANGE_BADMODE: wLOG("ChangeDisplaySettingsEx returned DISP_CHANGE_BADMODE [apply]"); break;

    case DISP_CHANGE_BADPARAM: wLOG("ChangeDisplaySettingsEx returned DISP_CHANGE_BADPARAM [apply]"); break;

    case DISP_CHANGE_FAILED: wLOG("ChangeDisplaySettingsEx returned DISP_CHANGE_FAILED [apply]"); break;

    case DISP_CHANGE_NOTUPDATED: wLOG("ChangeDisplaySettingsEx returned DISP_CHANGE_NOTUPDATED [apply]"); break;

    case DISP_CHANGE_RESTART:
      wLOG(
          "ChangeDisplaySettingsEx returned DISP_CHANGE_FAILED [apply] (You need to restart "
          "yout PC because you have Windows)");
      break;
