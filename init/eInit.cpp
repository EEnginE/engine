...
void eInit::_setThisForHandluSignal() {
 ...
 */
GLvoid eInit::s_advancedGrabControl( eEventInfo _info ) {
...
void eInit::handluSignal( int _signal ) {
...
void eInit::s_standardWindowClose( eEventInfo _info )  {
...
#if UNIX
   createContext();
   standardRender( eEventInfo( this ) );
   makeNOContextCurrent();
#endif
   continueMainLoop();
