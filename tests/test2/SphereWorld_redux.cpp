...
void SetupRC()
{
	...
	glBindTexture(GL_TEXTURE_2D, uiTextures[0]);
        ...
        std::string marble_str   = INSTALL_PREFIX; marble_str   += "/share/engineTests/test2/data/marble.tga";
        std::string marslike_str = INSTALL_PREFIX; marslike_str += "/share/engineTests/test2/data/marslike.tga";
        std::string moonlike_str = INSTALL_PREFIX; moonlike_str += "/share/engineTests/test2/data/moonlike.tga";
        std::cout << marble_str << std::endl;
	LoadTGATexture( "marble.tga"/*marble_str.c_str()*/, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR, GL_REPEAT);
	
	// Load Mars
	glBindTexture(GL_TEXTURE_2D, uiTextures[1]);
	LoadTGATexture( "marslike.tga"/*marslike_str.c_str()*/, GL_LINEAR_MIPMAP_LINEAR, 
				   GL_LINEAR, GL_CLAMP_TO_EDGE);
	
	// Load Moon
	glBindTexture(GL_TEXTURE_2D, uiTextures[2]);
	LoadTGATexture( "moonlike.tga" /*moonlike_str.c_str()*/, GL_LINEAR_MIPMAP_LINEAR,
				   GL_LINEAR, GL_CLAMP_TO_EDGE);
}
