...
set( GCC_ENABLE_CXX_14 "-std=c++14" )
if( CMAKE_CXX_COMPILER_ID MATCHES GNU AND GCC_COMPILER_VERSION LESS 4.8 )
   if( GCC_COMPILER_VERSION LESS 4.8 )
      message( FATAL_ERROR "Your GCC compiler version is to old! You need at least GCC v4.8" )
   endif( GCC_COMPILER_VERSION LESS 4.8 )
   set( GCC_ENABLE_CXX_14 "-std=c++1y" )
endif( CMAKE_CXX_COMPILER_ID MATCHES GNU AND GCC_COMPILER_VERSION LESS 4.8 )

set( GNU_COMPILER_OPTIONS_DEBUG   "-Wall ${GCC_ENABLE_CXX_14} ${DEF_GLEW_STATIC_GCC} ${GCC_VERBOSE}" )
set( GNU_COMPILER_OPTIONS_RELEASE "-Wall ${GCC_ENABLE_CXX_14} ${DEF_GLEW_STATIC_GCC} ${GCC_VERBOSE} -flto -O3" )
...
# Options LLVM
set( CLANG_ENABLE_CXX_14 "-std=c++14")

set( CLANG_COMPILER_OPTIONS_DEBUG   "${CLANG_ENABLE_CXX_14} ${DEF_GLEW_STATIC_CLANG} ${CLANG_VERBOSE}" )
set( CLANG_COMPILER_OPTIONS_RELEASE "${CLANG_ENABLE_CXX_14} ${DEF_GLEW_STATIC_CLANG} ${CLANG_VERBOSE}" )
...
elseif( CMAKE_CXX_COMPILER_ID MATCHES MSVC )
   #set( CMAKE_CXX_FLAGS_DEBUG   "${EXTRA_CXX_FLAGS} ${CMAKE_CXX_FLAGS_DEBUG}   ${MSVC_COMPILER_OPTIONS_DEBUG}" )    # Uncomment this when done with MSVC
   #set( CMAKE_CXX_FLAGS_RELEASE "${EXTRA_CXX_FLAGS} ${CMAKE_CXX_FLAGS_RELEASE} ${MSVC_COMPILER_OPTIONS_RELEASE}" )  # Uncomment this when done with MSVC
