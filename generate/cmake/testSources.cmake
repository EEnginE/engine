...
macro( testSources )
    if( NOT EXISTS ${PROJECT_SOURCE_DIR}/engine.cmake )
        message( STATUS "Can not find engine.cmake ==> Running ${PROJECT_SOURCE_DIR}/generate.sh" )
        execute_process( COMMAND ${PROJECT_SOURCE_DIR}/generate.sh )
    endif( NOT EXISTS ${PROJECT_SOURCE_DIR}/engine.cmake )
    ...
    include( ${PROJECT_SOURCE_DIR}/engine.cmake )
