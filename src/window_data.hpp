/// \file window_data.hpp
/// \brief \b Classes: \a eWindowData, \a eWinInfo
/// \sa e_window_data.cpp
/*
 *  E Engine
...
struct _eWindowData {
   ...
   e_engine_internal::__eWindowData_FBA      framebuffer;
   e_engine_internal::__eWindowData_Versions versions;
   e_engine_internal::__eWindowData_Window   win;
   e_engine_internal::__eLogData_Config      log;
   e_engine_internal::__eWindowData_Config   config;
