 ...
 */
void SHA_2::block( std::array<unsigned char, 128> const &_data ) {
   ...
   for ( t = 0; t < 16; ++t ) {
      word[t] = ( ( uint64_t )_data[t * 8 + 0] << 56 ) +
                ( ( uint64_t )_data[t * 8 + 1] << 48 ) +
                ( ( uint64_t )_data[t * 8 + 2] << 40 ) +
                ( ( uint64_t )_data[t * 8 + 3] << 32 ) +
                ( ( uint64_t )_data[t * 8 + 4] << 24 ) +
                ( ( uint64_t )_data[t * 8 + 5] << 16 ) +
                ( ( uint64_t )_data[t * 8 + 6] << 8 )  +
                ( ( uint64_t )_data[t * 8 + 7] );
   }
