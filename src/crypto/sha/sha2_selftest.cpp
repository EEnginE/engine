...
bool SHA_2::test( HASH_FUNCTION _type, const std::string &_message, const std::string &_result ) {
   reset( _type );
   add( _message );
   ...
   if ( lRes1_str != get() ) {
      eLOG    lName_str ADD ": '" ADD _message ADD '\''
      NEWLINE "RESULT 1: " ADD lRes1_str
      NEWLINE "RESULT 2: " ADD get()
      NEWLINE "EXPECTED: " ADD _result END
      return false;
   }

   if ( get() != _result ) {
      eLOG    lName_str ADD ": '" ADD _message ADD '\''
      NEWLINE "RESULT:   " ADD get()
      NEWLINE "EXPECTED: " ADD _result END
      return false;
   }

   iLOG "[OK] " ADD lName_str ADD ": '" ADD _message ADD '\'' END
...
bool SHA_2::selftest() {
   ...
   // SHA 384: abc
   // Hash:    CB00753F 45A35E8B B5A03D69 9AC65007 272C32AB 0EDED163 1A8B605A 43FF5BED 8086072B A1E7CC23 58BAECA1 34C825A7
   if ( !
         test(
            SHA2_384,
            "abc",
   ...
   // Hash:    09330C33 F71147E8 3D192FC7 82CD1B47 53111B17 3B3B05D2 2FA08086 E3B0F712 FCC7C71A 557E2DB9 66C3E9FA 91746039
   if ( !
         test(
            SHA2_384,
   ...
   // SHA 512: abc
   // Hash:    DDAF35A1 93617ABA CC417349 AE204131 12E6FA4E 89A97EA2 0A9EEEE6 4B55D39A 2192992A 274FC1A8 36BA3C23 A3FEEBBD 454D4423 643CE80E 2A9AC94F A54CA49F
   if ( !
         test(
            SHA2_512,
            "abc",
   ...
   // Hash:    8E959B75 DAE313DA 8CF4F728 14FC143F 8F7779C6 EB9F7FA1 7299AEAD B6889018 501D289E 4900F7E4 331B99DE C4B5433A C7D329EE B6DD2654 5E96E55B 874BE909
   if ( !
         test(
            SHA2_512,
            "abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu",
