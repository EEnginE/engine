...
class eContext : public eInitEventBasic, public eKeyboard, public eRandR {
   private:
      ...
      LRESULT CALLBACK        actualWndProc( UINT _uMsg, WPARAM _wParam, LPARAM _lParam, eEventInfo _tempInfo );
