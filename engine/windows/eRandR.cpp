 ...
 */
bool eRandR::setPrimary( const eDisplays &_disp ) {
 ...
 * \returns true
 */
bool eRandR::setDisplaySizes( const eDisplays &_disp ) {
 ...
 * \returns true
 */
bool eRandR::restoreScreenDefaults() {
 ...
 * \returns true
 */
bool eRandR::restoreScreenLatest() {
 ...
 * \returns false
 */
bool eRandR::setGamma( const eDisplays &_disp, float _r, float _g, float _b, float _brightness ) {
   return false;
}
