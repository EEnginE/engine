...
#if UNIX_X11
#include <GL/glxew.h>
#include "x11/eContext.hpp"
#include "eMouse.hpp"

#elif WINDOWS
#include "windows/eContext.hpp"
#endif
...
typedef GLvoid( *RENDER_FUNC )( eEventInfo info );
 ...
 *
 * \sa eContext uConfig e_eInit.cpp e_event.cpp
 */
#if UNIX_X11
...
class eInit : public windows_win32::eContext {
   ...
   private:
      ...
      static inline GLvoid standardRender( eEventInfo _info ) {
      ...
      GLvoid s_standardResize( eEventInfo _info ) {}

      //! The standard Window close function
      GLvoid s_standardWindowClose( eEventInfo _info );

      //! The standard Key function
      GLvoid s_standardKey( eEventInfo _info ) {}

      //! The standard Mouse function
      GLvoid s_standardMouse( eEventInfo _info ) {}
      
      //! The standard Mouse function
      GLvoid s_standardFocus( eEventInfo _info ) {
         iLOG "Focus " ADD _info.eFocus.hasFocus ? "got" : "lost" END
      }
      
      GLvoid s_advancedGrabControl( eEventInfo _info );
