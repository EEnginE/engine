...
struct __info_Output__ {
   ...
   __info_Output__(
         std::string _name, int _type, int _aSize, int _loc, int _locIndex, int _iPP, int _locComp )
       : name( _name ),
         type( _type ),
         arraySize( _aSize ),
         location( _loc ),
...
struct __info_Uniform__ {
   ...
   __info_Uniform__( std::string _name,
                     int _type,
                     int _aSize,
                     int _offset,
                     int _blockIndex,
...
struct __info_Uniform_Block__ {
   ...
   __info_Uniform_Block__(
         std::string _name, int _bufferBinding, int _bufferDataSize, int _numActivVars, int _index )
       : name( _name ),
