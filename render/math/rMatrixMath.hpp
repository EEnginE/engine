...
void rMatrixMath::getNormalMatrix(rMat3<T> const &_in, rMat3<T> &_out) {
  T lDeterminante =
      +_in.template get<0, 0>() *
          (_in.template get<1, 1>() * _in.template get<2, 2>() - _in.template get<1, 2>() * _in.template get<2, 1>()) -
      _in.template get<0, 1>() *
          (_in.template get<1, 0>() * _in.template get<2, 2>() - _in.template get<1, 2>() * _in.template get<2, 0>()) +
      _in.template get<0, 2>() *
          (_in.template get<1, 0>() * _in.template get<2, 1>() - _in.template get<1, 1>() * _in.template get<2, 0>());

  _out.template get<0, 0>() =
      +(_in.template get<1, 1>() * _in.template get<2, 2>() - _in.template get<2, 1>() * _in.template get<1, 2>());
  _out.template get<0, 1>() =
      -(_in.template get<1, 0>() * _in.template get<2, 2>() - _in.template get<2, 0>() * _in.template get<1, 2>());
  _out.template get<0, 2>() =
      +(_in.template get<1, 0>() * _in.template get<2, 1>() - _in.template get<2, 0>() * _in.template get<1, 1>());
  _out.template get<1, 0>() =
      -(_in.template get<0, 1>() * _in.template get<2, 2>() - _in.template get<2, 1>() * _in.template get<0, 2>());
  _out.template get<1, 1>() =
      +(_in.template get<0, 0>() * _in.template get<2, 2>() - _in.template get<2, 0>() * _in.template get<0, 2>());
  _out.template get<1, 2>() =
      -(_in.template get<0, 0>() * _in.template get<2, 1>() - _in.template get<2, 0>() * _in.template get<0, 1>());
  _out.template get<2, 0>() =
      +(_in.template get<0, 1>() * _in.template get<1, 2>() - _in.template get<1, 1>() * _in.template get<0, 2>());
  _out.template get<2, 1>() =
      -(_in.template get<0, 0>() * _in.template get<1, 2>() - _in.template get<1, 0>() * _in.template get<0, 2>());
  _out.template get<2, 2>() =
      +(_in.template get<0, 0>() * _in.template get<1, 1>() - _in.template get<1, 0>() * _in.template get<0, 1>());
  _out /= lDeterminante;
}
}
