...
struct uLogConverter<const std::wstring &> {
   static void convert( std::wstring &_str, const std::wstring &_t ) {
      _str.append( _t );
   }
};
...
static void convert( std::wstring &_str, wchar_t *_t ) {
   _str.append( _t );
}
};
...
static void convert( std::wstring &_str, const wchar_t *_t ) {
   _str.append( _t );
}
};
...
struct uLogConverter<bool> {
   static void convert( std::wstring &_str, bool _t ) {
